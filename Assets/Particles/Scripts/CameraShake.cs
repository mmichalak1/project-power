...
public class CameraShake : MonoBehaviour
{
    ...
    IEnumerator Shake()
    {
        ...
        {
            Vector3 rotationAmount = originalRotation.eulerAngles + Random.insideUnitSphere * shakeAmount;//A Vector3 to add to the Local Rotation
        ...
        transform.localRotation = originalRotation;//Set the local rotation to 0 when done, just to get rid of any fudging stuff.
        isRunning = false;
    }
